...
class WasteClassifier:
    ...
    def scan_image(self, image_bytes: bytes) -> Tuple[str, ClassificationResult]:
        ...
        prompt = (
            "You are an expert waste segregation AI.\n"
            "Look at this image and identify the single most prominent waste or garbage item.\n\n"
            "Return ONLY valid JSON — no markdown fences, no explanation — matching exactly:\n"
            "{\n"
            "  \"object_name\": \"concise waste item name (e.g. crushed plastic bottle, banana peel, cardboard box)\",\n"
            "  \"confident\": true,\n"
            "  \"wet_dry\": \"Dry\" or \"Wet\",\n"
            "  \"recyclable\": \"Recyclable\" or \"Non-recyclable\",\n"
            "  \"biodegradable\": \"Biodegradable\" or \"Non-biodegradable\",\n"
            "  \"recommended_bin\": one of: \"Recyclable Dry Waste (Blue Bin)\" | \"Organic / Wet Waste (Green Bin)\" | \"Hazardous Waste (Red Bin)\" | \"General Waste (Black Bin)\",\n"
            "  \"bin_color\": \"#2563eb\" for recyclable dry, \"#16a34a\" for wet/organic, \"#dc2626\" for hazardous, \"#475569\" for general waste,\n"
            "  \"explanation\": \"Clear 2-sentence explanation of why and how to dispose of it.\"\n"
            "}\n\n"
            "If you cannot clearly identify a waste item, set \"confident\": false and all other string fields to \"\"."
        )
